...
> Hand-computed; assert ±0.5% unless stated. Pure `compute(inputs)` tested directly. **[v3] adds T13–T15 for the plot module.**

**T1 — EMI.** loan 10,000,000; 7.5%; 20y → EMI ≈ 80,559/mo (±₹50).
**T2 — Zero-rate EMI.** loan 1,200,000; 0%; 10y → 10,000/mo exactly.
**T3 — Rent path + drag.** rent0 30,000/mo; g 7/6/5; drag 2% → rent_annual(5)=504,918; (10)=675,640; (15)≈815,150; (20)≈945,000 (±1%).
**T4 — Structure direction.** sbua 1,000; replCost0 2,300; infl 6%; phys 1.67%+econ 1.5%; age0 0; salvage 0.10 → struct(0)=2,300,000; struct(10)=1,000×2,300×1.06^10×(1−0.317)=2,300×1.7908×0.683≈2,813,400 (rises early); struct(40): depFactor floored 0.10; 1.06^40=10.286 → ≈2,365,700.
**T5 — Land.** uds 600; landRate0 38,000; 8%/6% → landRate(10)=82,054→landValue 49,232,400; landRate(20)=146,940→landValue 88,164,000 (±0.5%).
...
**T10 — XIRR.** −1,000,000 @ t0, +6,727,500 @ t20 → 10.00% (±0.01%).
