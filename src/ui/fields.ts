...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "rentGrowthY1_5", label: "Rent step Y1–5", kind: "pct", unit: "% / term", def: "Rent increase applied at each lease renewal in years 1–5 (rent is flat within a term)." },
      { key: "rentGrowthY6_10", label: "Rent step Y6–10", kind: "pct", unit: "% / term", def: "Rent increase applied at each lease renewal in years 6–10." },
      { key: "rentGrowthY11_20", label: "Rent step Y11–20", kind: "pct", unit: "% / term", def: "Rent increase applied at each lease renewal in years 11–20." },
      { key: "rentGrowthY21_30", label: "Rent step Y21–30", kind: "pct", unit: "% / term", def: "Rent increase applied at each lease renewal in years 21–30. Defaults to the Y11–20 rate; lower it to taper later-decade growth.", minHorizon: 21 },
